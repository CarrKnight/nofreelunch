...
dr_sumstat<-read_csv("./data/personalities/personalities.csv",
                     col_names=TRUE) %>% select_if(function(x){var(x)>0})
...
# I add to add a "row.number" column name to the file to read this correctly
dr_parameters<-
  read_csv("./data/anasazi/params_personalities.csv",
                     col_names=TRUE) %>%
