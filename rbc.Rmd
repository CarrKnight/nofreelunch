...
RBC model from gecon, looking only at the cross-correlation table between $Y$ and $L$, $Y$ and $r$, $Y$ and $C$, $Y$ and $I$.
...
total_data<-read_csv("./data/gecon/rbc_simple.csv")
param_names<-c("sigma","beta","delta", "eta", "mu","phi")
