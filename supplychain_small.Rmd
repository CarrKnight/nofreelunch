...
dr_sumstat<-read_csv("./data/supplychain/supplychain.csv",
                     col_names=TRUE) 
...
# I add to add a "row.number" column name to the file to read this correctly
dr_parameters<-
  read_csv("./data/supplychain/params_supplychain.csv",
                     col_names=TRUE) %>%
