...
knitr::opts_chunk$set(echo = FALSE, warning= FALSE, message=FALSE,
                      cache=FALSE,cache.extra = knitr::rand_seed,
...
dr_sumstat<-read_csv("./data/peerreview/peerreview.csv",
                     col_names=TRUE) 
...
# I add to add a "row.number" column name to the file to read this correctly
dr_parameters<-
  read_csv("./data/peerreview/params_peerreview.csv",
                     col_names=TRUE) %>%
