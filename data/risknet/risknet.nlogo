...
;  if (ticks > timesteps - 1)  [ stop ]
  ...
  with-local-randomness [ update-view ]
  ifelse fraction-active != 0  [
    set all-budget total-budget / (number-households * fraction-active)
  ] [
    set all-budget 0
  ]
  ifelse fraction-active-uninsured != 0 [
    set uninsured-budget total-budget-uninsured / ((number-households - insured-households) * fraction-active-uninsured)
  ] [
     set uninsured-budget 0
  ]
  tick
end
